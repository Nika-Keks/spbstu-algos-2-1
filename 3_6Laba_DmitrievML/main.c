...
int main() {
    printf("\nDmitriev Mikhail, 5030102/10002, <3 laba> \n");
    char *cEname1 = "Matrix1.txt";
    char *cEname2 = "Matrix2.txt";
    sizee_t Size1;
    sizee_t Size2;
    sizee_t Size3;

    stolbec_t *Matrix1 = ReadFile(cEname1, &Size1);
    printf("Matrix 1:\n");
    Print(Matrix1, Size1);

    stolbec_t *Matrix2 = ReadFile(cEname2, &Size2);
    printf("Matrix 2:\n");
    Print(Matrix2, Size2);
